...
export const LAB_FUNCTIONS: LabFunction[] = [
  ...
  { key: "letter_draft", name: "Response letter drafting", promptId: "RESP-LTR-DRAFT-v31", stageKey: STAGE_KEYS.LETTER, usesKnowledge: false, description: "Draft a professional response letter to the IRS." },
  { key: "qa_chat", name: "Tax Q&A assistant", promptId: "RESP-AST-v31", stageKey: STAGE_KEYS.QA, usesKnowledge: true, description: "Conversational plain-English tax help, grounded in the knowledge base." },
