...
function evidenceFirstBranches(): AnswerBranch[] {
  return [
    ...
    },
    {
      ...
      explanation:
        "Upload or identify the notice code (for example CP14, CP501, CP503, CP504, CP90, LT11, Letter 3172). The notice’s printed amount and deadline usually set the next move.",
    },
  ];
}
