...
export default async function GuestResultPage({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SiteHeader />
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-12 pb-16">
        <div className="text-center">
          ...
          <Card className="mt-4 border-dashed">
            <CardBody className="text-center">
              <p className="text-sm font-semibold text-slate-900">
                {locked.length} more {locked.length === 1 ? "result" : "results"} + your action plan
              </p>
              <p className="mt-1 text-sm text-slate-500">Create a free account to unlock the full analysis.</p>
            </CardBody>
          </Card>
        )}
