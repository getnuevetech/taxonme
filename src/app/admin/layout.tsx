...
const NAV: { area: string; href: string; label: string; section: string }[] = [
  ...
  { area: "admin.ai", href: "/admin/intelligence", label: "Conversation intel", section: "Intelligence" },
  ...
  { area: "admin.content", href: "/admin/updates", label: "IRS updates", section: "Content" },
